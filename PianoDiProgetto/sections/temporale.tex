...
\begin{figure}[H]
\centering
	\begin{subfigure}[Costo]
		{\includegraphics[width=.45\textwidth]{img/Costo.png}}
	\end{subfigure} \quad
	\begin{subfigure}[Ore previste]
		{\includegraphics[width=.45\textwidth]{img/OrePreviste.png}}
	\end{subfigure}\\
	\begin{subfigure}[Durata]
		{\includegraphics[width=.45\textwidth]{img/Durata.png}}
	\end{subfigure}
\caption{Grafici di riepilogo costi e durate}
\label{fig: grafici di riepilogo costi e durate}
\end{figure}
...
\begin{longtable}[H]{|>{\centering}p{6cm}| >{\centering}p{2cm}| >{\centering}m{2cm}| >{\centering}p{1.3cm}| >{\centering}p{1.2cm}|}
    ...
    \textbf{Costo (\euro)} \tabularnewline \hline
		...
		Analisi di nuove tecnologie & 06/06/2013 & 10/06/2013 & 3 & 279 \tabularnewline \hline
\end{longtable}
\end{center}
