...
\begin{figure}[H]
  \begin{center}
\includegraphics[width=0.60\textwidth]{../template/img/UC4_ModificaIndirizziMailDaSincronizzare.png}
...
\begin{figure}[H]
  \begin{center}
\includegraphics[width=0.60\textwidth]{../template/img/UC5_ModificheDB.png}
