...
\begin{longtable}[H]{|>{\centering}p{5cm}| >{\centering}m{3cm}| >{\centering}m{3cm}|}
	...
	\hline
    \caption{Costi risorse intellettuali}
...
\begin{longtable}[H]{|>{\centering}p{5cm}| >{\centering}p{3cm}|}
	...
	\hline
    \caption{Riepilogo dei costi}
    \label{tab: Tabella riepilogativa dei costi}
\end{longtable}
\end{center}

Il team stima nel primo anno di raggiungere almeno 350 clienti, proponendo per il prodotto un prezzo di vendita pari a 120 \euro{}. Il break-even point con questi dati si raggiungerebbe gi\`{a} al primo anno.
